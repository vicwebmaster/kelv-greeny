                ...
                <div class="col-lg-12">
                    <div class="account-card">
                        ...
                        <div class="account-content">
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="profile-image"><Link to="/Profile"><img src="./Assest/images/user.png" alt="user"/></Link>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="profile-btn"><Link to="/ChangePass">change pass.</Link></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="account-card mb-0">
                        ...
                        <div class="account-content">
                            <div class="row">
                                <div class="col-md-6 col-lg-4 alert fade show">
                                    <div class="payment-card payment active"><img src="./Assest/images/payment/png/01.png"
                                            alt="payment"/>
                                        <h4>card number</h4>
                                ...
                                <div class="col-md-6 col-lg-4 alert fade show">
                                    <div class="payment-card payment"><img src="./Assest/images/payment/png/02.png"
                                            alt="payment"/>
                                        <h4>card number</h4>
                                        <p><span>****</span><span>****</span><span>****</span><sup>1876</sup></p>
                                        <h5>miron mahmud</h5><button class="trash icofont-ui-delete" title="Remove This"
                                ...
                                <div class="col-md-6 col-lg-4 alert fade show">
                                    <div class="payment-card payment"><img src="./Assest/images/payment/png/03.png"
                                            alt="payment"/>
                                        <h4>card number</h4>
                                        <p><span>****</span><span>****</span><span>****</span><sup>1876</sup></p>
                                        <h5>miron mahmud</h5><button class="trash icofont-ui-delete" title="Remove This"
            ...
            <div class="modal-content"><button class="modal-close" data-bs-dismiss="modal"><i
                ...
                <form class="modal-form">
                    ...
                    <div class="form-group"><label class="form-label">email</label><input class="form-control"
                            type="text" value="mironcoder@gmail.com"/></div><button class="form-btn" type="submit">save
                        profile info</button>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content"><button class="modal-close" data-bs-dismiss="modal"><i
                ...
                <form class="modal-form">
                    ...
                    <div class="form-group"><label class="form-label">number</label><input class="form-control"
                            type="text" placeholder="+8801838288389"/></div><button class="form-btn" type="submit">save contact
                        info</button>
                </form>
            </div>
        </div>
